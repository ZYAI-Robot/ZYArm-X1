...
def _default_controllers_file() -> Path:
    return _package_share("zyarm_control") / "config" / "zyarm_x1_plus_real_controllers.yaml"
...
def generate_launch_description():
    ...
    xacro_file = description_share / "urdf" / "x1_plus" / "robot.urdf.xacro"
    rviz_file = description_share / "rviz" / "display_x1_plus.rviz"
    ...
    controller_manager = Node(
        ...
        name="zyarm_x1_plus_controller_manager",
        output="screen",
        parameters=[
    ...
    robot_state_publisher = Node(
        ...
        name="zyarm_x1_plus_robot_state_publisher",
        output="screen",
    ...
    joint_state_broadcaster_spawner = Node(
        package="controller_manager",
        executable="spawner",
        name="zyarm_x1_plus_joint_state_broadcaster_spawner",
        output="screen",
        arguments=[
            "joint_state_broadcaster",
            "--controller-manager",
            "/zyarm_x1_plus_controller_manager",
        ],
    )
    ...
    arm_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        name="zyarm_x1_plus_arm_controller_spawner",
        output="screen",
        arguments=[
            "arm_controller",
            "--controller-manager",
    ...
    gripper_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        name="zyarm_x1_plus_gripper_controller_spawner",
        output="screen",
        arguments=[
            "gripper_controller",
            "--controller-manager",
