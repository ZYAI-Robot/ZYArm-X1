...
def generate_launch_description():
    ...
    default_model = package_share / "urdf" / "x1_plus" / "robot.urdf.xacro"
    default_rviz = package_share / "rviz" / "display_x1_plus.rviz"
    ...
    jsp = Node(
        ...
        name="zyarm_x1_plus_joint_state_publisher_gui",
        output="screen",
        parameters=[{"robot_description": robot_description}],
    ...
    jsp_headless = Node(
        ...
        name="zyarm_x1_plus_joint_state_publisher",
        output="screen",
        parameters=[{"robot_description": robot_description}],
