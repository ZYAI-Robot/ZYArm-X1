...
def generate_launch_description():
    ...
    srdf_file = moveit_share / "srdf" / "zyarm_x1_plus.srdf"
    rviz_file = moveit_share / "rviz" / "moveit_x1_plus.rviz"
    ...
    bringup = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            str(bringup_share / "launch" / "bringup_x1_plus_real_ros2_control.launch.py")
        ),
