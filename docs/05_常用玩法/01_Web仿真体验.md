...
> 安全提醒：网页里的“模型预览”“填写草稿”“拖动滑块”不会驱动真机；“发送到机械臂”“真实预览”“运行全部”“待机”“复位”“停止”“硬件重启”等操作会真实发送指令。第一次操作时请空载、低速、保持手远离夹爪和连杆。
...
- `待机`：让机械臂进入低功耗待机姿态 `[0 -105 90 0 0 0 0]`，到位后继续锁定保持。它适合动作间隙或任务结束后减少普通姿态下的舵机发热，不是急停，也不是电机下电。
...
- 想把多个动作串起来：继续看 [Web 动作编排工作流](08_Web动作编排工作流.md)。
