...
| 目标 | 推荐系统 | 本章准备 |
| --- | --- | --- |
| 只跑通真机串口 | Windows 优先，Ubuntu 可用 | 不需要额外环境，直接看 [快速上手](../02_快速上手/README.md) |
| 使用 Python SDK 或 tools | Windows / Ubuntu | Python、虚拟环境、`software/zyarm_sdk/python` |
| 使用 Web 仿真 | Windows / Ubuntu / macOS | Node.js、pnpm、`web/` |
...
- [ ] 已确认自己的目标路线。
- [ ] 已完成 [快速上手](../02_快速上手/README.md) 中的基础串口验证。
- [ ] 已确认目标路线需要安装哪些额外环境。
- [ ] 已完成目标框架的安装验证。
- [ ] 复杂框架只在需要时安装。
