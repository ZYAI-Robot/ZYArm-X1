...
如果你只是想运行现有 Python、ROS 2、MoveIt 或 Gazebo 示例，请先阅读 [仿真与框架接入](../06_仿真与框架接入/README.md)。本章主要面向源码修改、接口扩展、测试验证和交付维护。
...
| 判断一个功能该改哪一层 | [仓库结构与模块边界](02_仓库结构与模块边界.md) | `firmware/`、`software/`、`docs/` |
...
| 修改 LeRobot 插件、数据字段或适配逻辑 | [LeRobot 开发](06_LeRobot开发/README.md) | `software/lerobot_robot_zyarm/` |
| 增加示例、工具或压测脚本 | [示例工具与诊断开发](07_示例工具与诊断开发.md) | `software/examples/`、`software/tools/`、`software/diagnostics/` |
| 准备提交、发布或交付 | [测试发布与贡献检查](08_测试发布与贡献检查.md) | 全仓库 |
...
- `software/lerobot_robot_zyarm/` 承载 LeRobot 原生适配，不依赖 ROS 2；使用教程见 [科研与数据采集](../07_科研与数据采集/README.md)，源码修改见 [LeRobot 开发](06_LeRobot开发/README.md)。
